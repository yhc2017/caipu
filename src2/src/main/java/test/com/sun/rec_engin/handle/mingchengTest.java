...
//TODO: Test goes here...
    ...
    vec1.put("∆§µ∞",1.973);vec1.put(" ›»‚",1.889);vec1.put("÷‡",1.093);
    vec2.put("—Ú»‚",2.448);vec2.put("Ã¿",1.426);
...
//TODO: Test goes here...
    ...
    vec1.put("∆§µ∞",value[0]);vec1.put(" ›»‚",value[1]);vec1.put("÷‡",value[2]);
    vec2.put("—Ú»‚",value[3]);vec2.put("Ã¿",value[4]);
